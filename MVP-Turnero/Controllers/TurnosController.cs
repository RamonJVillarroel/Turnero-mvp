...
namespace MVP_Turnero.Controllers
{
    public class TurnosController : Controller
    {
        ...
        {
            var turnoDbContext = _context.Turnos.Include(t => t.Cliente).Include(t => t.Profesional).Include(t => t.TipoServicio);
        ...
        {
            ViewData["ClienteId"] = new SelectList(_context.Clientes, "UsuarioId", "UsuarioId");
            ViewData["ProfesionalId"] = new SelectList(_context.Profesional, "UsuarioId", "UsuarioId");
            ViewData["TipoServicioId"] = new SelectList(_context.TipoServicios, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProfesionalId,ClienteId,TipoServicioId,FechaHoraInicio,FechaHoraFin")] Turno turno)
        {
